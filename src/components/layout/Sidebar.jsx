...
const Sidebar = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  return (
    <div className={`fixed md:relative top-0 left-0 w-64 h-full bg-gray-100 border-r border-gray-300 transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform md:translate-x-0`}>
      ...
      <div className="p-4 flex flex-col items-center">
        ...
        <p className="font-medium text-gray-900">Hey, {user?.username || 'ABCD'}</p>
      </div>

      {/* Navigation */}
      <nav className="px-4 space-y-0">
        <a href="#" className="flex items-center px-4 py-2 bg-white shadow-sm text-gray-700">
          <svg className="w-5 h-5 mr-3" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
          </svg>
          All Tasks
        </a>
        <a href="#" className="flex items-center px-4 py-2 bg-green-100 text-green-700 shadow-sm">
          <svg className="w-5 h-5 mr-3" viewBox="0 0 24 24" fill="none" stroke="currentColor">
      ...
      <div className="px-4 mt-4">
        <button className="flex items-center w-full px-4 py-2 bg-white shadow-sm text-gray-700">
          <svg className="w-5 h-5 mr-3" viewBox="0 0 24 24" fill="none" stroke="currentColor">
