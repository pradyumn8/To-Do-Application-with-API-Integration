          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 w-full">
            <div className="flex-1 flex flex-col sm:flex-row items-center gap-2 w-full">
              ...
              <input
                ...
                className="flex-1 w-full sm:w-auto bg-transparent border-none outline-none text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 p-2"
              />
            </div>

            <button
              type="submit"
              className="w-full sm:w-auto px-4 py-2 bg-green-500 text-white text-sm font-medium rounded-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
            >
              ADD TASK
            </button>
          </div>
