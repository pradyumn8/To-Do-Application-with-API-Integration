...
const WeatherWidget = () => {
  ...
  return (<div className="w-full max-w-[452px] h-full p-4 mb-6 bg-white dark:bg-gray-800 rounded-lg shadow-md sm:w-[452px]">
    ...
    <form onSubmit={handleLocationChange} className="flex mb-4 space-x-2">
      <div className="w-full max-w-[452px] h-full p-4 mb-6 bg-white dark:bg-gray-800 rounded-lg shadow-md sm:w-[452px]">
        <form className="flex flex-col sm:flex-row gap-3">
          <input
            type="text"
            name="location"
            placeholder="Enter city name"
            className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
